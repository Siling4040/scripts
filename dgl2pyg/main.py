...
class GraphFmtConverter:
    ...
    def process(self):
        for filename in tqdm(os.listdir(self.dgl_dir)):
    ...
    def process_one_graph(self, dgl_path, pyg_path):
        ...
        graph_pyg = self.dgl2pyg(graph_dgl)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", type=str, default="../../data/dgl", help="Path to the input DGL graph files")
    parser.add_argument("-o", type=str, default="../../data/pyg", help="Path to save the output PyG graph files")
    args = parser.parse_args()

    print("Source (DGL):", args.i)
    print("Destination (PyG):", args.o)
    print("Starting conversion...")
    converter = GraphFmtConverter(args.i, args.o)
    converter.process()
